...
try:
    shanghaiAtrain_path = '/content/CCTrans/data/ShanghaiTech/part_A_final/train_data/images_crop/'
    shanghaiAtest_path = '/content/CCTrans/data/ShanghaiTech/part_A_final/test_data/images_crop/'
